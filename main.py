...
class KanbanWindow(QMainWindow):
    ...
    def setup_ui(self):
        ...
        # Always on top será definido pelo toggle_always_on_top baseado nas configurações
        # Não definir aqui para não remover outros flags importantes
    ...
    def apply_theme(self):
        ...
        if self.dark_mode:
            ...
            # Calcular cor do texto baseado na luminosidade (se houver cor salva)
            if header_color_saved:
                color = QColor(header_color_saved)
